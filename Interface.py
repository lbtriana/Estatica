...
if authenticate_user():
    ...
    if action == "Estudiar":
        ...
        if way == "Teoría":
            ...
            if topic == "Sistemas equivalentes":
        ...
        with center_col:
            if difficulty == "Fácil":
                ...
                if subtopic == "Sistemas equivalentes":
                    ...
                    if pregunta_no == 4:
                        st.image(SE_image_paths[9], width=450)
                    if pregunta_no == 5:
                        st.image(SE_image_paths[10], width=300)
            ...
            if difficulty == "Medio":
                ...
                if subtopic == "Sistemas equivalentes":
                    ...
                    if pregunta_no == 4:
                        st.image(SE_image_paths[11], width=450)
                    if pregunta_no == 5:
                        st.image(SE_image_paths[12], width=450)
                if subtopic == "Incertidumbre":
                    if pregunta_no == 1:
                ...
                if subtopic == "Vigas":
                    if pregunta_no == 1:
                        st.image(FD_image_paths[13], width=550)  
                    if pregunta_no == 2:
                        st.image(FD_image_paths[14], width=450) 
                if subtopic == "Presión hidrostática":
                    if pregunta_no == 1:
                ...
                if subtopic == "Empuje de suelo":
                    ...
                    if pregunta_no == 2:
                        st.image(FD_image_paths[20], width=400)
                    if pregunta_no == 3:
                        st.image(FD_image_paths[21], width=650)
                if subtopic == "Fuerzas internas":
                    if pregunta_no == 1:
        ...
        with left_col:
            ...
            if difficulty == "Medio":
                ...
                if subtopic == "Empuje de suelo":
                    ...
                    if pregunta_no ==2:
                        st.image(FD_rtas_paths[24], width=350)   
                    if pregunta_no ==3:
                        st.image(FD_rtas_paths[25], width=400)  
                if subtopic == "Fuerzas internas":
                    if pregunta_no == 1:
   ...
   #Función para mostrar la imagen de la pregunta de teoría
    def filtrar_imagenes_teoria(pregunta_no, subtopic):
        ...
        with center_col:
            ...
            if subtopic == "Momento":
                if pregunta_no == 4:
                    st.image(MO_teoria_preguntas[2], width=550) 
                if pregunta_no == 5:
                    st.image(MO_teoria_preguntas[1], width=150) 
                if pregunta_no == 6:
            ...
            if subtopic == "Sistemas equivalentes":
                ...
                if pregunta_no == 4:
                    st.image(SI_teoria_preguntas[2], width=800) 
                if pregunta_no == 5:
                    st.image(SI_teoria_preguntas[3], width=600) 
            if subtopic == "Apoyos y reacciones":
                if pregunta_no == 1:
                    st.image(AP_teoria_preguntas[0], width=600) 
                if pregunta_no == 2:
                    st.image(AP_teoria_preguntas[1], width=400) 
                if pregunta_no == 3:
                    st.image(AP_teoria_preguntas[2], width=400)
            if subtopic == "Cerchas":
                if pregunta_no == 1:
                ...
                if pregunta_no == 3:
                    st.image(AR_teoria_preguntas[4], width=550) 
                if pregunta_no == 4:
                    st.image(AR_teoria_preguntas[5], width=550) 
                if pregunta_no == 5:
            ...
            if subtopic == "Centroides":
                ...
                if pregunta_no == 7:
                    st.image(CT_teoria_preguntas[5], width=300)
                if pregunta_no == 9:
        ...
        with left_col:
            if subtopic == "Presión hidrostática":
                ...
                if pregunta_no == 5:
                    st.image(FD_teoria_preguntas[9], width=900)
        return
