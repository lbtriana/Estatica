...
conceptuales = [
    ...
    Theory(#2
        ...
        topic = "Equilibrio de partículas",
        subtopic = "Vectores",
        enunciado = "Dado dos vectores $\overrightarrow{A}$ y $\overrightarrow{B}$, ¿Cuál es el ángulo entre ellos minimiza la magnitud de su suma $\overrightarrow{A} + \overrightarrow{B}$?. Sugerencia: Use el método punta-cola para sumar vectores.",
        opcion_1 = "$0^\circ$",
        opcion_2 = "$180^\circ$",
        opcion_3 = "$90^\circ$",
        opcion_4 = "$45^\circ$",
    ...
    Theory(#3
        ...
        topic = "Equilibrio de partículas",
        subtopic = "Vectores",
        enunciado = "Dado dos vectores $\overrightarrow{A}$ y $\overrightarrow{B}$, ¿Cuál es el ángulo entre ellos maximiza la magnitud de su suma $\overrightarrow{A} + \overrightarrow{B}$?. Sugerencia: Use el método punta-cola para sumar vectores.",
        opcion_1 = "$0^\circ$",
        opcion_2 = "$180^\circ$",
        opcion_3 = "$90^\circ$",
        opcion_4 = "$45^\circ$",
